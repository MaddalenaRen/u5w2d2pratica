package it.epicode.u5w2d2pratica.configuration;
...
public class AppConfig {
    ...
    @Bean
    /*
    questo metodo serve per creare un oggetto Cloudinary, che quindi ci permetta di
    uploadare file. Va creata una mappa con all'interno le proprietà per accedere al servizio
